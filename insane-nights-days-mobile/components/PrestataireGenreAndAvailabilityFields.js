...
const styles = StyleSheet.create({
  ...
  chipActive: { borderColor: Colors.primary, backgroundColor: 'rgba(255,23,68,0.15)' },
  ...
  dayButtonActive: { borderColor: Colors.primary, backgroundColor: 'rgba(255,23,68,0.15)' },
