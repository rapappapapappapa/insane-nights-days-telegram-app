...
export const API_CONFIG = {
  ...
  ENDPOINTS: {
    ...
    PROFILE_PRESTATAIRE: '/api/profile/prestataire',
    ...
    PRESTATAIRE_PROFILE: '/api/prestataire/profile',
    DJ_BOOKINGS: '/api/dj/bookings',
    VENUE_BOOKINGS: '/api/venue/bookings',
    PRESTATAIRE_BOOKINGS: '/api/prestataire/bookings',
    ...
    PRESTATAIRE_ACCEPT_INVITATION: '/api/prestataire/invitations',
    PRESTATAIRE_REJECT_INVITATION: '/api/prestataire/invitations',
