...
| Profils publics | `DjProfilePage`, `VenueProfilePage`, `BookerProfilePage` | **Onglets Figma (17 sept.)** | Accueil + Feed/Events/Media/Avis artiste & orga ; manques API médias/avis booker |
