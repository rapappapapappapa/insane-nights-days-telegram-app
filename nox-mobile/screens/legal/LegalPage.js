...
Les présentes Conditions Générales d'Utilisation (CGU) régissent l'utilisation de l'application NOX. En créant un compte, vous acceptez sans réserve ces CGU.

## 2. Description du service

NOX est une plateforme mettant en relation la communauté, les DJs, les organisateurs et les lieux pour la découverte et l'organisation d'événements musicaux.
...
These Terms of Use govern the use of the NOX application. By creating an account, you accept these terms without reservation.

## 2. Service description

NOX is a platform connecting the community, DJs, organizers and venues for discovering and organizing music events.
...
Les présentes CGV s'appliquent aux achats de tickets d'événements effectués via NOX. En cochant la case d'acceptation avant chaque achat, vous acceptez sans réserve ces CGV.
...
These Terms of Sale apply to event ticket purchases made through NOX. By checking the acceptance box before each purchase, you accept these terms without reservation.
