...
const styles = StyleSheet.create({
  ...
  chip: { paddingHorizontal: 12, paddingVertical: 8, borderRadius: 20, backgroundColor: 'rgba(255,255,255,0.08)', borderWidth: 1, borderColor: 'rgba(77,163,255,0.3)' },
  chipActive: { backgroundColor: 'rgba(77,163,255,0.3)', borderColor: Colors.primary },
  chipText: { color: '#fff', fontSize: 13 },
  chipTextActive: { color: Colors.primary, fontWeight: '600' },
  friendsBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, padding: 14, borderRadius: 12, borderWidth: 1, borderColor: 'rgba(77,163,255,0.4)', marginBottom: 16 },
